...
Ce projet propose un module Python permettant d’estimer le temps de désorbitation d’un satellite évoluant en orbite basse terrestre en tenant compte de l'effet des forces de traînée atmosphérique et électromagnétique. Le dispositif considéré pour permettre la génération d'une traînée électromagnétique exercée sur le satellite est décrit dans l'article [1].
